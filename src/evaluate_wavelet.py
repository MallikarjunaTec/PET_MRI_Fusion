...
FUSED_PATH = "results/wavelet_fused_image.nii.gz"
...
print("Loading Wavelet fused image...")
...
print("\n==========================================")
print("       WAVELET FUSION EVALUATION")
print("==========================================")
...
output_file = "results/wavelet_metrics.txt"

with open(output_file, "w") as file:

    file.write("WAVELET PET-MRI FUSION EVALUATION\n")
    file.write("=================================\n\n")
